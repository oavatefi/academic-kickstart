        ...
        { /* active_coding_dataset.das_cfg */
            { /* active_coding_dataset.das_cfg.dapm_cfg */
                ...
                { /* active_coding_dataset.das_cfg.dapm_cfg.vehicle_cfg */
                    ...
                    2030, /* default_wheel_circ_front_mm */ /* Changed from 2130 - 12.04.2017, from 2090 - 10.05.2017 (Thomas), from 2060(correct wheel size), (Wheels changed. 1950 is the current size) (30.05.2017) */
                    2030, /* default_wheel_circ_rear_mm */
                ...
                {58983,59844,60709,61580,62454,63333,64213,65095,441,1323,2204,3082,3957,4827,5693,6552}, /* wheel_ang_front_bw_tbl_u16f - from Anto (4.7.2017)*/
...
#      endif
                ...
                { /* active_coding_dataset.das_cfg.vdim_cfg.sect_hysteresis_cfg */
                    80, /* hyst_dist_time_a_ms */
                    240, /* hyst_dist_time_d_ms */
                    500, /* hyst_dist_ss_time_a_ms */
                    1000, /* hyst_dist_ss_time_d_ms */
                    80, /* hyst_obj_time_entry_ms */
                    240, /* hyst_obj_time_exit_ms */
...
#ifdef CFGD_ODOMETRY
                    3, /* nb_pulses_release_fast_standstill */
#endif
#ifdef CFGD_ODOMETRY
