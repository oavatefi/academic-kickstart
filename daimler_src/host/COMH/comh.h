...
#define COMH_NUM_SECTORS_MAX DAPM_NUM_SECTORS_REAR
#if DAPM_NUM_SECTORS_FRONT > DAPM_NUM_SECTORS_REAR
#  undef COMH_NUM_SECTORS_MAX
#  define COMH_NUM_SECTORS_MAX DAPM_NUM_SECTORS_FRONT
#endif
#if DAPM_NUM_SECTORS_SIDE > DAPM_NUM_SECTORS_FRONT
#  undef COMH_NUM_SECTORS_MAX
#  define COMH_NUM_SECTORS_MAX DAPM_NUM_SECTORS_SIDE
#endif
